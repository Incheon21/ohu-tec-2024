        ...
        <div className="pb-5 lg:flex">
          ...
          <div className="flex flex-col m-5 text-sm basis-1/3 lg:mx-20">
            ...
            <div className="flex items-center my-2">
              ...
              <div className="ml-3">
                <a href="https://www.instagram.com/tec.ohu/">@tec.ohu</a>
                <br />
          ...
          <div className="flex flex-col m-5 text-sm basis-1/3 lg:mx-20">
            <h1 className="font-bold">For any questions and detailed information, please don’t hesitate to contact</h1>
            <div className="flex items-center mt-2">
              <FaLine size="2em" />
              <div className="ml-3">
                <h2>{"/*Insert Zizah's Line ID here*/"}</h2>
              </div>
            </div>
            <div className="flex items-center mt-2">
              <FaLine size="2em" />
              <div className="ml-3">
                <h2>{"/*Insert Veli's Line ID here*/"}</h2>
              </div>
            </div>
            {/* 
            <div className='flex items-center mt-2'>
